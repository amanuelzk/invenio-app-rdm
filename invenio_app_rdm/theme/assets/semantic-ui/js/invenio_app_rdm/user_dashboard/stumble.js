...
export const Stumble = () => {
  ...
  return (
    <div>
      <section
        className="content1 cid-rVMdmjU4Mx"
        style={{
          backgroundImage: "url(static/images/gresis-patter-3.jpg)",
          backgroundSize: "contain",
          backgroundRepeatX: "repeat",
          backgroundBlendMode: "darken",
          backgroundColor: "#b55e2e",
        ...
        <div className="container" style={{ padding: 30 }}>
          <div className="row justify-content-end">
            <div className="title__block col-lg-12">
              <h3
                className="gresis-section-title gresis-fonts-style display-2"
                style={{ color: "#eee", padding: 30 }}
              >
                Stumble<span className="verline" />
              </h3>
              <h4
                style={{
                  color: "#eee",
              ...
              >
                {i18next.t(
                  "The stumble, like a serendipitous wanderer, unveils treasures unforeseen, guiding the seeker to unexpected realms of wisdom, much like a researcher stumbling upon a hidden gem in the library of knowledge."
                )}
                <p />
              </h4>
            </div>
